            ...
            <div class="col-sm-12">
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <form role="form" class="form-horizontal"  action="<c:if test="${edit==true }">${path }/admin/pro/update</c:if><c:if test="${edit==false }">${path }/admin/pro/add</c:if><c:if test="${edit==null }">${path }/admin/pro/save</c:if>" method="post">
                            <input type="hidden" name="id" value="${record.id }">
                                        ...
                                        <div class="form-group">
                                           <label class="col-sm-2 control-label" for="xueyuanid">学院</label>
                                            <div class="col-sm-10">
                                                <select required class="form-control" <c:if test="${edit==false }">disabled</c:if> name="xueyuanid">
                                                <c:forEach items="${xueyuans}" var="s">
                                                    <option value="${s.id }" <c:if test="${s.id==record.xueyuanid}"> selected </c:if>>
                                                ${s.name }
                                                    </option>
                                                </c:forEach>
                                                </select>
                            ...
                            <div class="form-group">
                                <c:if test="${edit==false }"><a href="${path }/admin/pro" class="btn btn-gray btn-single">返回</a></c:if>
