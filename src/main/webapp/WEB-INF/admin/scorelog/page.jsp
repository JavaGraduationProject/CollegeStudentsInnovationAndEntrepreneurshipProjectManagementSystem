...
<div class="page-container">
    ...
    <div class="main-content">
        ...
        <div class="page-title">
            ...
            <form class="form-horizontal" method="post" action="${path }/admin/scorelog">
                    ...
                    <c:forEach var="d" items="${datas.data }">
                        <tr>
                            ...
                            <td>
                                ...
                                <a  class="btn btn-secondary btn-sm btn-icon icon-left" href="${path}/admin/project/view?id=${d.projectid }" >查看项目</a>
                                <a  class="btn btn-secondary btn-sm btn-icon icon-left" href="${path}/admin/scorelog/edit?id=${d.id }" >评分</a>
                            </td>
                        </tr>
                    </c:forEach>
                    </tbody>
