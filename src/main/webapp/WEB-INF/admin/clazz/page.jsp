...
<div class="page-container">
    ...
    <div class="main-content">
        ...
        <div class="page-title">
            ...
            <form class="form-horizontal" method="post" action="${path }/admin/clazz">
                ...
                <div class="form-group">
                    ...
                    <label class="col-xs-1 control-label">学院</label>
                    <div class="col-xs-2">
                    ...
                    <div class="col-xs-2">
                        <select required class="form-control" name="proid" id="proid">
                            <option value="">请选择</option>
                    ...
                    <div class="col-xs-2 btn-group pull-right">
                        <a href="${path }/admin/clazz/add" class="btn btn-info btn-sm ">新增</a>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a class="btn btn-secondary btn-sm btn-icon icon-left"
                                   href="${path}/admin/clazz/view?id=${d.id }">查看</a>
                                <a class="btn btn-info btn-sm btn-icon icon-left"
                                   href="${path}/admin/clazz/edit?id=${d.id }">编辑</a>
                                <a class="btn btn-danger btn-sm btn-icon icon-left"
                                   href="${path}/admin/clazz/del?id=${d.id }">删除</a>
                            </td>
                        </tr>
                    </c:forEach>
                    </tbody>
